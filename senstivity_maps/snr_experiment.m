...
%                     w(:,t,b) = zeros(size(w,1),1);
    ...
    % Necessary for 0.1 Jy %%%%%%%%%%%%%%%%%
%     SNR(abs(SNR) > 0.06) = NaN;
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    
    % SNR vs position %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    SNRp_dB_fig = figure();
    SNR_freq = 150;
    plot(1:size(SNR,1), 10*log10(abs(SNR(:,SNR_freq)).'));
    ...
    SNRp_fig = figure();
    plot(1:size(SNR,1), abs(SNR(:,SNR_freq)).');
